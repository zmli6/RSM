...
enum OptionKeyword {
    ...
    Mode = 15               // -mode, The mode of running the algorithm
};
...
public:
    ...
    std::string getFilterType() {
        return options_value[OptionKeyword::Filter] == "" ? "GQL" : options_value[OptionKeyword::Filter];
    }

    std::string getOrderType() {
        return options_value[OptionKeyword::Order] == "" ? "RI" : options_value[OptionKeyword::Order];
    }

    std::string getEngineType() {
        return options_value[OptionKeyword::Engine] == "" ? "QSI" : options_value[OptionKeyword::Engine];
    }
    ...
    std::string getTimeLimit() {
        return options_value[OptionKeyword::SpectrumAnalysisTimeLimit] == "" ? "500" : options_value[OptionKeyword::SpectrumAnalysisTimeLimit];
    }
    ...
    std::string getMode() {
        return options_value[OptionKeyword::Mode] == "" ? "Test" : options_value[OptionKeyword::Mode];
    }
};
